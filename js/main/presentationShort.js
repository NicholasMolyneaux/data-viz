...
function presentationShort() {
    ...
    firstTextLine.innerHTML = "<h2 id='textLine1' style='display: none'>You can explore the movements of pedestrians in a few different environments.</h2>";
    ...
    secondTextLine.innerHTML = "<h2 id='textLine2' style='display: none'>Valuable insight can be gained thanks to the visualizations presented here. </h2>";
    ...
    idTO = setTimeout(function() {
            firstTextLine.innerHTML = "<h2 id='textLine1' style='display: none'>For example, this is the western underpass of the station in Lausanne.</h2>";
    ...
    idTO = setTimeout(function() {
        ...
        // Main text container 2
        let secondTextLine = document.createElement("div");
        secondTextLine.innerHTML = "<h2 id='textLine2' style='display: none'></h2>";
        ...
        let paddingDiv = document.createElement("div");
        paddingDiv.innerHTML = "<h2> </h2>";
        paddingDiv.classList.add("presentationOn3D");
        paddingDiv.classList.add("presentation-padding");
        document.getElementById("mainViz").appendChild(paddingDiv);
    ...
    idTO = setTimeout(function() {
        ...
        transition.style.backgroundColor = "#FFFFFF";
        ...
        fadeInFadeOut("transition3D2D", 250, 250);
    ...
    idTO = setTimeout(function() {
        ...
        let transition = document.createElement("div");
        transition.classList.add("presentationOn3D");
        transition.id = "transition3D2D-2";
        transition.style.backgroundColor = "#FFFFFF";
    ...
    idTO = setTimeout(function() {
        ...
        fadeOut("transition3D2D-2", 500);
        fadeOut("titleForPres", 500);
        fadeOut("textLine1", 500);
    }, time);
    time += 500;
    timeOutPres.push(idTO);
