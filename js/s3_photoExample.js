...
Amplify.configure({
    Auth: {
        identityPoolId: 'eu-west-3:952bf1d0-741c-4ae4-ab5e-e80effcc89f9', //REQUIRED - Amazon Cognito Identity Pool ID
        region: 'eu-west-3', // REQUIRED - Amazon Cognito Region
        userPoolId: 'eu-west-3_AHJkvc7rs', //OPTIONAL - Amazon Cognito User Pool ID
        userPoolWebClientId: 'XX-XXXX-X_abcd1234', //OPTIONAL - Amazon Cognito Web Client ID
    },
    Storage: {
        AWSS3: {
            bucket: 'walking-data-s3-bucket', //REQUIRED -  Amazon S3 bucket name
            region: 'eu-west-3', //OPTIONAL -  Amazon service region
        }
    }
});


async function onChangeUpload(e) {
    console.log("hello from onChangeUpload ! ");
    var files = document.getElementById("myphotoupload").files;
    const file = files[0];
    try {
...
var albumBucketName = "walking-data-s3-bucket";
var bucketRegion = "eu-west-3";
var IdentityPoolId = "eu-west-3:0d9e01ae-d18d-488c-914f-d9d892362da4";
